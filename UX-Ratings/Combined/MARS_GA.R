...
run_Mars <- function(filename,result_file_name,prediction_file_name,n_components=0, perform_pca=FALSE,transformation=FALSE,data='study1'){
  ...
  if (transformation==TRUE){
    ...
    {
      normality_test_features_path ='/mnt/vdb1/UX-Ratings/NormalityCheck/combined_univariate_normality_test_features_mahalanobis_transformed.csv'
    }
...
perform_evaluation <- function(X_train,y_train,X_test,y_test,results_file_name,n_components,perform_pca=FALSE){
  result<- data.frame(matrix(ncol=13,nrow=1))
  colnames(result)<- c("#Features","Adjusted R2(Validation)","Features",#"R2(Test)",
                       "R2(Train)","R2(Validation)",
                       #"RMSE(Test)",
                       "RMSE(Train)","RMSE(Validation)","StandardError(Validation)",
                       #"MAE(Test)",
                       "MAE(Train)","MAE(Validation)",'AIC(Validation)',
                       #'AIC(Test)',
                       'BIC(Validation)',#'BIC(Test)',
...
filename<- "/mnt/vdb1/datasets/files_generated/UX/combined_features_data_out_mahalanobis.csv"

# 
result_file_name<-"/mnt/vdb1/UX-Ratings/Combined/Tables/combined_feature_selection_mahalanobis_alltargets.csv"
n_components <-0
prediction_file_name <- "/mnt/vdb1/UX-Ratings/Combined/Residuals/combined_feature_selection_alltargets_mahalanobis_predictions.xlsx"
...
result_file_name<-"/mnt/vdb1/UX-Ratings/Combined/Tables/combined_feature_selection_mahalanobis_alltargets_PCA_0.95PC.csv"
n_components <-0.95
prediction_file_name <- "/mnt/vdb1/UX-Ratings/Combined/Residuals/combined_feature_selection_alltargets_mahalanobis_PCA_0.95PC_predictions.xlsx"
...
result_file_name<-"/mnt/vdb1/UX-Ratings/Combined/Tables/combined_feature_selection_mahalanobis_alltargets_PCA_0.80PC.csv"
n_components <-0.80
prediction_file_name <- "/mnt/vdb1/UX-Ratings/Combined/Residuals/combined_feature_selection_alltargets_mahalanobis_PCA_0.8PC_predictions.xlsx"
# run_Mars(filename,result_file_name,prediction_file_name,n_components, perform_pca=TRUE,transformation=FALSE)

# evaluate model on study1 data on original distribution after PCA with 3 PCs
#filename <- "/mnt/vdb1/datasets/files_generated/UX/study1_features_data_out_mahalanobis.csv"
result_file_name<-"/mnt/vdb1/UX-Ratings/Combined/Tables/combined_feature_selection_mahalanobis_alltargets_PCA_3PC.csv"
n_components <-3
prediction_file_name <- "/mnt/vdb1/UX-Ratings/Combined/Residuals/combined_feature_selection_alltargets_mahalanobis_PCA_3_predictions.xlsx"
...
filename<- "/mnt/vdb1/datasets/files_generated/UX/combined_features_data_out_mahalanobis_transformedDistributions.csv"


result_file_name<-"/mnt/vdb1/UX-Ratings/Combined/Tables/combined_feature_selection_mahalanobis_transformed_alltargets.csv"
n_components <-0
prediction_file_name <- "/mnt/vdb1/UX-Ratings/Combined/Residuals/combined_feature_selection_alltargets_mahalanobis_transformed_predictions.xlsx"
...
result_file_name<-"/mnt/vdb1/UX-Ratings/Combined/Tables/combined_feature_selection_mahalanobis_transformed_alltargets_PCA_0.95PC.csv"
n_components <-0.95
prediction_file_name <- "/mnt/vdb1/UX-Ratings/Combined/Residuals/combined_feature_selection_alltargets_mahalanobis_transformed_PCA_0.95PC_predictions.xlsx"
...
#filename <- "/mnt/vdb1/datasets/files_generated/UX/study1_features_data_out_mahalanobis_transformedDistributions.csv"
result_file_name<-"/mnt/vdb1/UX-Ratings/Combined/Tables/combined_feature_selection_mahalanobis_transformed_alltargets_PCA_0.80PC.csv"
n_components <-0.80
prediction_file_name <- "/mnt/vdb1/UX-Ratings/Combined/Residuals/combined_feature_selection_alltargets_mahalanobis_transformed_PCA_0.8PC_predictions.xlsx"
run_Mars(filename,result_file_name,prediction_file_name,n_components, perform_pca=TRUE,transformation=TRUE,data='study1')

# evaluate model on study1 data on transformed distribution after PCA with 3 PCs
#filename <- "/mnt/vdb1/datasets/files_generated/UX/study1_features_data_out_mahalanobis_transformedDistributions.csv"
result_file_name<-"/mnt/vdb1/UX-Ratings/Combined/Tables/combined_feature_selection_mahalanobis_transformed_alltargets_PCA_3PC.csv"
n_components <-3
prediction_file_name <- "/mnt/vdb1/UX-Ratings/Residuals/combined_feature_selection_alltargets_mahalanobis_transformed_PCA_3_predictions.xlsx"
