...
# setwd("/mnt/vdb1/")
run_Mars <- function(filename,result_file_name,prediction_file_name,n_components=0, perform_pca=FALSE,transformation=FALSE,data='study1'){
  #load csv
...
result_file_name<-"/mnt/vdb1/UX-Ratings/Tables/study1_feature_selection_mahalanobis_alltargets.csv"
n_components <-0
prediction_file_name <- "/mnt/vdb1/UX-Ratings/Residuals/study1_feature_selection_alltargets_mahalanobis_predictions.xlsx"
...
filename <- "/mnt/vdb1/datasets/files_generated/UX/study1_features_data_out_mahalanobis.csv"
result_file_name<-"/mnt/vdb1/UX-Ratings/Tables/study1_feature_selection_mahalanobis_alltargets_PCA_0.95PC.csv"
n_components <-0.95
prediction_file_name <- "/mnt/vdb1/UX-Ratings/Residuals/study1_feature_selection_alltargets_mahalanobis_PCA_0.95_predictions.xlsx"
...
filename <- "/mnt/vdb1/datasets/files_generated/UX/study1_features_data_out_mahalanobis.csv"
result_file_name<-"/mnt/vdb1/UX-Ratings/Tables/study1_feature_selection_mahalanobis_alltargets_PCA_0.80PC.csv"
n_components <-0.80
prediction_file_name <- "/mnt/vdb1/UX-Ratings/Residuals/study1_feature_selection_alltargets_mahalanobis_PCA_0.8_predictions.xlsx"
run_Mars(filename,result_file_name,prediction_file_name,n_components, perform_pca=TRUE,transformation=FALSE)

# evaluate model on study1 data on original distribution after PCA with 3 PCs
filename <- "/mnt/vdb1/datasets/files_generated/UX/study1_features_data_out_mahalanobis.csv"
result_file_name<-"/mnt/vdb1/UX-Ratings/Tables/study1_feature_selection_mahalanobis_alltargets_PCA_3PC.csv"
n_components <-3
prediction_file_name <- "/mnt/vdb1/UX-Ratings/Residuals/study1_feature_selection_alltargets_mahalanobis_PCA_3_predictions.xlsx"
run_Mars(filename,result_file_name,prediction_file_name,n_components, perform_pca=TRUE,transformation=FALSE,data='study1')
...
result_file_name<-"/mnt/vdb1/UX-Ratings/Tables/study1_feature_selection_mahalanobis_transformed_alltargets.csv"
n_components <-0
prediction_file_name <- "/mnt/vdb1/UX-Ratings/Residuals/study1_feature_selection_alltargets_mahalanobis_transformed_predictions.xlsx"
run_Mars(filename,result_file_name,prediction_file_name,n_components, perform_pca=FALSE,transformation=TRUE,data='study1')

# evaluate model on study1 data on transformed distribution after PCA with 95% explained variance PCs
filename <- "/mnt/vdb1/datasets/files_generated/UX/study1_features_data_out_mahalanobis_transformedDistributions.csv"
result_file_name<-"/mnt/vdb1/UX-Ratings/Tables/study1_feature_selection_mahalanobis_transformed_alltargets_PCA_0.95PC.csv"
n_components <-0.95
prediction_file_name <- "/mnt/vdb1/UX-Ratings/Residuals/study1_feature_selection_alltargets_mahalanobis_transformed_PCA_0.95_predictions.xlsx"
run_Mars(filename,result_file_name,prediction_file_name,n_components, perform_pca=TRUE,transformation=TRUE,data='study1')

# evaluate model on study1 data on transformed distribution after PCA with 80% explained variance PCs
filename <- "/mnt/vdb1/datasets/files_generated/UX/study1_features_data_out_mahalanobis_transformedDistributions.csv"
result_file_name<-"/mnt/vdb1/UX-Ratings/Tables/study1_feature_selection_mahalanobis_transformed_alltargets_PCA_0.80PC.csv"
n_components <-0.80
prediction_file_name <- "/mnt/vdb1/UX-Ratings/Residuals/study1_feature_selection_alltargets_mahalanobis_transformed_PCA_0.8_predictions.xlsx"
run_Mars(filename,result_file_name,prediction_file_name,n_components, perform_pca=TRUE,transformation=TRUE,data='study1')

# evaluate model on study1 data on transformed distribution after PCA with 3 PCs
filename <- "/mnt/vdb1/datasets/files_generated/UX/study1_features_data_out_mahalanobis_transformedDistributions.csv"
result_file_name<-"/mnt/vdb1/UX-Ratings/Tables/study1_feature_selection_mahalanobis_transformed_alltargets_PCA_3PC.csv"
n_components <-3
prediction_file_name <- "/mnt/vdb1/UX-Ratings/Residuals/study1_feature_selection_alltargets_mahalanobis_transformed_PCA_3_predictions.xlsx"
run_Mars(filename,result_file_name,prediction_file_name,n_components, perform_pca=TRUE,transformation=TRUE,data='study1')
...
# filename <- "/mnt/vdb1/datasets/files_generated/UX/study1_features_data_out_mahalanobis.csv"
filename <- "/mnt/vdb1/datasets/files_generated/UX/study2_features_data_out_mahalanobis.csv"
result_file_name<-"/mnt/vdb1/UX-Ratings/Tables/study2_feature_selection_mahalanobis_alltargets.csv"
n_components <-0
prediction_file_name <- "/mnt/vdb1/UX-Ratings/Residuals/study2_feature_selection_alltargets_mahalanobis_predictions.xlsx"
run_Mars(filename,result_file_name,prediction_file_name,n_components, perform_pca=FALSE,transformation=FALSE,data='study2')


# evaluate model on study2 data on original distribution after PCA with 95% explained variance PCs
filename <- "/mnt/vdb1/datasets/files_generated/UX/study2_features_data_out_mahalanobis.csv"
result_file_name<-"/mnt/vdb1/UX-Ratings/Tables/study2_feature_selection_mahalanobis_alltargets_PCA_0.95PC.csv"
n_components <-0.95
prediction_file_name <- "/mnt/vdb1/UX-Ratings/Residuals/study2_feature_selection_alltargets_mahalanobis_PCA_0.95_predictions.xlsx"
run_Mars(filename,result_file_name,prediction_file_name,n_components, perform_pca=TRUE,transformation=FALSE,data='study2')
# study2_feature_selection_alltargets_mahalanobis_PCA_0.95_predictions
# evaluate model on study2 data on original distribution after PCA with 80% explained variance PCs
filename <- "/mnt/vdb1/datasets/files_generated/UX/study2_features_data_out_mahalanobis.csv"
result_file_name<-"/mnt/vdb1/UX-Ratings/Tables/study2_feature_selection_mahalanobis_alltargets_PCA_0.80PC.csv"
n_components <-0.80
prediction_file_name <- "/mnt/vdb1/UX-Ratings/Residuals/study2_feature_selection_alltargets_mahalanobis_PCA_0.8_predictions.xlsx"
run_Mars(filename,result_file_name,prediction_file_name,n_components, perform_pca=TRUE,transformation=FALSE,data='study2')

# evaluate model on study2 data on original distribution after PCA with 3 PCs
filename <- "/mnt/vdb1/datasets/files_generated/UX/study2_features_data_out_mahalanobis.csv"
result_file_name<-"/mnt/vdb1/UX-Ratings/Tables/study2_feature_selection_mahalanobis_alltargets_PCA_3PC.csv"
n_components <-3
prediction_file_name <- "/mnt/vdb1/UX-Ratings/Residuals/study2_feature_selection_alltargets_mahalanobis_PCA_3_predictions.xlsx"
run_Mars(filename,result_file_name,prediction_file_name,n_components, perform_pca=TRUE,transformation=FALSE,data='study2')
...
# filename <- "/mnt/vdb1/datasets/files_generated/UX/study2_features_data_out_mahalanobis_transformedDistributions.csv"
filename <- "/mnt/vdb1/datasets/files_generated/UX/study2_features_data_out_mahalanobis_transformedDistributions.csv"
result_file_name<-"/mnt/vdb1/UX-Ratings/Tables/study2_feature_selection_mahalanobis_transformed_alltargets.csv"
n_components <-0
prediction_file_name <- "/mnt/vdb1/UX-Ratings/Residuals/study2_feature_selection_alltargets_mahalanobis_transformed_predictions.xlsx"
run_Mars(filename,result_file_name,prediction_file_name,n_components, perform_pca=FALSE,transformation=TRUE,data='study2')


# evaluate model on study2 data on transformed distribution after PCA with 95% explained variance PCs
filename <- "/mnt/vdb1/datasets/files_generated/UX/study2_features_data_out_mahalanobis_transformedDistributions.csv"
result_file_name<-"/mnt/vdb1/UX-Ratings/Tables/study2_feature_selection_mahalanobis_transformed_alltargets_PCA_0.95PC.csv"
n_components <-0.95
prediction_file_name <- "/mnt/vdb1/UX-Ratings/Residuals/study2_feature_selection_alltargets_mahalanobis_transformed_PCA_0.95_predictions.xlsx"
run_Mars(filename,result_file_name,prediction_file_name,n_components, perform_pca=TRUE,transformation=TRUE,data='study2')

# evaluate model on study2 data on transformed distribution after PCA with 80% explained variance PCs
filename <- "/mnt/vdb1/datasets/files_generated/UX/study2_features_data_out_mahalanobis_transformedDistributions.csv"
result_file_name<-"/mnt/vdb1/UX-Ratings/Tables/study2_feature_selection_mahalanobis_transformed_alltargets_PCA_0.80PC.csv"
n_components <-0.80
prediction_file_name <- "/mnt/vdb1/UX-Ratings/Residuals/study2_feature_selection_alltargets_mahalanobis_transformed_PCA_0.8_predictions.xlsx"
run_Mars(filename,result_file_name,prediction_file_name,n_components, perform_pca=TRUE,transformation=TRUE,data='study2')

# evaluate model on study2 data on transformed distribution after PCA with 3 PCs
filename <- "/mnt/vdb1/datasets/files_generated/UX/study2_features_data_out_mahalanobis_transformedDistributions.csv"
result_file_name<-"/mnt/vdb1/UX-Ratings/Tables/study2_feature_selection_mahalanobis_transformed_alltargets_PCA_3PC.csv"
n_components <-3
prediction_file_name <- "/mnt/vdb1/UX-Ratings/Residuals/study2_feature_selection_alltargets_mahalanobis_transformed_PCA_3_predictions.xlsx"
run_Mars(filename,result_file_name,prediction_file_name,n_components, perform_pca=TRUE,transformation=TRUE,data='study2')
