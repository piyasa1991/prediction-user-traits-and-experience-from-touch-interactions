...
# 
# evaluate model on study2 data on original distribution feature"s
filename_1 <- "/mnt/vdb1/datasets/files_generated/UX/study2_features_data_out_mahalanobis.csv"
filename_2 <- "/mnt/vdb1/datasets/files_generated/UX/study1_features_data_out_mahalanobis.csv"
# 
result_file_name<-"/mnt/vdb1/UX-Ratings/Generalizability/Train-Study2-Test-Study1/Tables/feature_selection_mahalanobis_alltargets.csv"
n_components <-0
prediction_file_name <- "/mnt/vdb1/UX-Ratings/Generalizability/Train-Study2-Test-Study1/study2_feature_selection_alltargets_mahalanobis_predictions_unseen.xlsx"
...
result_file_name<-"/mnt/vdb1/UX-Ratings/Generalizability/Train-Study2-Test-Study1/Tables/feature_selection_mahalanobis_alltargets_PCA_0.95PC.csv"
n_components <-0.95
prediction_file_name <- "/mnt/vdb1/UX-Ratings/Generalizability/Train-Study2-Test-Study1/study2_feature_selection_alltargets_mahalanobis_PCA_0.95_predictions_unseen.xlsx"
...
result_file_name<-"/mnt/vdb1/UX-Ratings/Generalizability/Train-Study2-Test-Study1/Tables/feature_selection_mahalanobis_alltargets_PCA_0.80PC.csv"
n_components <-0.80
prediction_file_name <- "/mnt/vdb1/UX-Ratings/Generalizability/Train-Study2-Test-Study1/study2_feature_selection_alltargets_mahalanobis_PCA_0.8_predictions_unseen.xlsx"
run_Mars(filename_1,filename_2,result_file_name,prediction_file_name,n_components, perform_pca=TRUE,transformation=FALSE)

# evaluate model on study1 data on original distribution after PCA with 3 PCs
#filename <- "/mnt/vdb1/datasets/files_generated/UX/study1_features_data_out_mahalanobis.csv"
result_file_name<-"/mnt/vdb1/UX-Ratings/Generalizability/Train-Study2-Test-Study1/Tables/feature_selection_mahalanobis_alltargets_PCA_3PC.csv"
n_components <-3
prediction_file_name <- "/mnt/vdb1/UX-Ratings/Generalizability/Train-Study2-Test-Study1/study2_feature_selection_alltargets_mahalanobis_PCA_3_predictions_unseen.xlsx"
...
filename_1 <- "/mnt/vdb1/datasets/files_generated/UX/study2_features_data_out_mahalanobis_transformedDistributions.csv"
filename_2 <- "/mnt/vdb1/datasets/files_generated/UX/study1_features_data_out_mahalanobis_transformedDistributions.csv"


result_file_name<-"/mnt/vdb1/UX-Ratings/Generalizability/Train-Study2-Test-Study1/Tables/feature_selection_mahalanobis_transformed_alltargets.csv"
n_components <-0
prediction_file_name <- "/mnt/vdb1/UX-Ratings/Generalizability/Train-Study2-Test-Study1/study2_feature_selection_alltargets_mahalanobis_transformed_predictions_unseen.xlsx"
...
result_file_name<-"/mnt/vdb1/UX-Ratings/Generalizability/Train-Study2-Test-Study1/Tables/feature_selection_mahalanobis_transformed_alltargets_PCA_0.95PC.csv"
n_components <-0.95
prediction_file_name <- "/mnt/vdb1/UX-Ratings/Generalizability/Train-Study2-Test-Study1/study2_feature_selection_alltargets_mahalanobis_transformed_PCA_0.95_predictions_unseen.xlsx"
...
#filename <- "/mnt/vdb1/datasets/files_generated/UX/study1_features_data_out_mahalanobis_transformedDistributions.csv"
result_file_name<-"/mnt/vdb1/UX-Ratings/Generalizability/Train-Study2-Test-Study1/Tables/feature_selection_mahalanobis_transformed_alltargets_PCA_0.80PC.csv"
n_components <-0.80
prediction_file_name <- "/mnt/vdb1/UX-Ratings/Generalizability/Train-Study2-Test-Study1/study2_feature_selection_alltargets_mahalanobis_transformed_PCA_0.8_predictions_unseen.xlsx"
run_Mars(filename_1,filename_2,result_file_name,prediction_file_name,n_components, perform_pca=TRUE,transformation=TRUE,data='study1')

# evaluate model on study1 data on transformed distribution after PCA with 3 PCs
#filename <- "/mnt/vdb1/datasets/files_generated/UX/study1_features_data_out_mahalanobis_transformedDistributions.csv"
result_file_name<-"/mnt/vdb1/UX-Ratings/Generalizability/Train-Study2-Test-Study1/Tables/feature_selection_mahalanobis_transformed_alltargets_PCA_3PC.csv"
n_components <-3
prediction_file_name <- "/mnt/vdb1/UX-Ratings/Generalizability/Train-Study2-Test-Study1/study2_feature_selection_alltargets_mahalanobis_transformed_PCA_3_predictions_unseen.xlsx"
run_Mars(filename_1,filename_2,result_file_name,prediction_file_name,n_components, perform_pca=TRUE,transformation=TRUE,data='study1')
